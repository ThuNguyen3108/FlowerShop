    ...
    <main>
        ...
        <div class="container marketing" id="ourproducts">
            ...
            <div class="services-info col-md-12">
                <h2 class="section-title2"><span id="CONTENTS_PWD_TITLE" class="multilang">TÌM KIẾM SẢN PHẨM</span></h2>
            </div>
            ...
            $sqlGetHH = "SELECT * FROM `hanghoa` WHERE `TenHH` LIKE '%$name%'";
            $result = $conn->query($sqlGetHH);

            if (mysqli_num_rows($result) == 0) {
            ?>

                <center>
                    <div style="width:100%" class="alert alert-danger w-100 block">
