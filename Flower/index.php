        ...
        <div class="container marketing" id="ourproducts">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="i1">
                        <img src="<?= $rows['Anh'] ?>" height="200" width="200" alt="ảnh hoa hướng dương"><br><br><br>
                    </div>
                    ...
                    <p><a class="btn btn-secondary" href="ProductsPage.php?loai_hoa=<?= $rows['duongdan']?>"><span id="CONTENTS_SEEDS_BTN" class="multilang">Đọc thêm</span></a></p>
                </div>
                <!-- /.col-lg-4 -->
                <?php }?>
                <!-- /.col-lg-4 -->
