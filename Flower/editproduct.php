        ...
        <main class="edit_main">
            <form enctype="multipart/form-data" action="editproduct.php?mshh=<?php echo $mshh; ?>" method="POST">
                ...
                if ($row = mysqli_fetch_array($query)) {
                    ...
                    $sqlGetAnh = "Select * from hinhhh where MSHH = $row[MSHH]";
                    $resultAnh = $conn->query($sqlGetAnh);
                    $firstResult = $resultAnh->fetch_assoc();
                ?>
                    ...
                    <div class="form-input-group">
                        ...
                        <img class="editproduct__img" width=90px heigh="90px" src="img/products/<?php echo $firstResult['Anh'] ?>" alt='img-product'>
                    ...
                    <div class="form-input-group">
                        ...
                        <textarea name="chitietsp" id="chitietsp" cols="30" rows="10"><?= $row['MoTaHH'] ?>
                        </textarea>
                        <div class="form-input-error-message"></div>
                    </div>
                    ...
                    <div class="form-input-group">
                        ...
                        <textarea name="ghichu" id="ghichu" cols="30" rows="10"><?php echo $row['GhiChu'] ?>
                        </textarea>
                        <div class="form-input-error-message"></div>
                    </div>
